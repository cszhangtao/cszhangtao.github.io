...
author_profile: true
---
- Associate Editor, IEEE Transactions on Software Engineering (TSE)
- Associate Editor, Journal of Systems and Software (JSS)
- Board Member of Distinguished Reviewers, ACM Transactions on Software Engineering and Methodology (TOSEM) 
- Steering Committee Member, IEEE International Conference on Software Analysis, Evolution and Reengineering (SANER), 2023-Now
